                            ...
                            <form class="form-horizontal" action="/admin/users" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" placeholder="Nhập lại mật khẩu người dùng..." name="password" >
                                    </div>
                                    <div class="form-group">
                                        <label for="avatar">Hình đại diện*</label>
                                        <input type="file" class="form-control" id="avatar" placeholder="Chọn ảnh đại diện người dùng..." name="avatar" >
                                    </div>
                                    <div class="form-group">
