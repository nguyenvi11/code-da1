...
?>
  <?php
      var_dump('commentByProductChart');
      ?>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-3">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                ...
                                <h6 class="text-white">Lọại sản phẩm</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-3">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-coffee"><?= $data['total_product'] ?></i></h1>
                    ...
                    <div class="col-md-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-comment-processing"><?= $data['total_comment'] ?></i></h1>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="cart-title">Thống kê sản phẩm theo loại</h4>
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="cart-title">Thống kê 5 sản phẩm được bình luận nhiều nhất </h4>
                            </div>
